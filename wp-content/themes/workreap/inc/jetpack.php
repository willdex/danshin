...
function workreap_jetpack_setup() {
	...
	add_theme_support(
		...
		array(
			'post-details' => array(
				'stylesheet' => 'workreap-style',
				'date'       => '.workreap-posted-on',
				'categories' => '.workreap-cat-links',
				'tags'       => '.workreap-tags-links',
				'author'     => '.workreap-byline',
				'comment'    => '.workreap-comments-link',
			),
