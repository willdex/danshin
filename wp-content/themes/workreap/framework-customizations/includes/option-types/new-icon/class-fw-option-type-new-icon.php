...
class FW_Option_Type_NewIcon extends FW_Option_Type {
    ...
    private function generate_unknown_set($icon) {
        return array (
		   ...
		   'container-class' => '' ,
		   'groups'          => array (
							  'unknown' => esc_html__('Unknown Set' , 'workreap') ,
		   ) ,
		   'icons'           => array (
    ...
    private function get_default_sets() {
        return array (
		   'font-awesome' => array (// http://fortawesome.github.io/Font-Awesome/icons
			  ...
			  'groups'          => array (
				 'web-application' => esc_html__('Web Application Icons' , 'workreap') ,
				 'hand'            => esc_html__('Hand Icons' , 'workreap') ,
				 'transportation'  => esc_html__('Transportation Icons' , 'workreap') ,
				 'gender'          => esc_html__('Gender Icons' , 'workreap') ,
				 'file-type'       => esc_html__('File Type Icons' , 'workreap') ,
				 'payment'         => esc_html__('Payment Icons' , 'workreap') ,
				 'currency'        => esc_html__('Currency Icons' , 'workreap') ,
				 'text-editor'     => esc_html__('Text Editor Icons' , 'workreap') ,
				 'directional'     => esc_html__('Directional Icons' , 'workreap') ,
				 'video-player'    => esc_html__('Video Player Icons' , 'workreap') ,
				 'brand'           => esc_html__('Brand Icons' , 'workreap') ,
				 'medical'         => esc_html__('Medical Icons' , 'workreap') ,
				 'workreap'         => esc_html__('Workreap Icons' , 'workreap') ,
			  ) ,
			  'icons' => array(
