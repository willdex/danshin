	...
	<div class="js-option-type-new-icon-container">
		...
		<div class="fw-backend-option-fixed-width">
			<select class="js-option-type-new-icon-dropdown">
				<?php
					echo fw_html_tag('option', array('value' => 'all'), htmlspecialchars(esc_html__('All Categories', 'workreap')));
			...
			<div class="fw-icon-search-holder">
				<input type="text" class="fw-icon-search" placeholder="<?php esc_attr_e('icon search', 'workreap'); ?>">
