...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 float-left">
	...
	<form method="get" name="serach-projects" action="<?php echo esc_url($action_url);?>" class="four-column-filter">
...
<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 float-left">
	<div class="row">
		<?php if ( $service_data->have_posts()) {?>
			<div class="wt-freelancers-holder three-column-holder">
				<?php 
					...
					?>
					<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 wt-services-grid">
