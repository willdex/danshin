	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="wt-dashboardbox">
			<div class="wt-dashboardboxtitle wt-titlewithsearch">
				<h2><?php esc_html_e('Manage ongoing projects','workreap');?></h2>
				<?php do_action('workreap_dashboard_search_keyword','projects','ongoing');?>
			</div>
			<div class="wt-dashboardboxcontent wt-jobdetailsholder">
				<div class="wt-freelancerholder">
					<div class="wt-tabscontenttitle">
						<h2><?php esc_html_e('All ongoing projects','workreap');?></h2>
					</div>
					...
					<?php
						if( $query->have_posts() ){
							...
							do_action('workreap_empty_records_html','wt-empty-person',esc_html__( 'No ongoing project.', 'workreap' ),true);
						}?>								
					</div>
				</div>
				<?php
