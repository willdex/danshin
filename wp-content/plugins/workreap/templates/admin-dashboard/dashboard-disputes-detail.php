					...
					<fieldset>
						<div class="form-group-wrap">
							...
							<div class="form-group wr-dbtnarea wr-dbtnarea-row">
								<a href="javascript:void(0);" class="wr-btn resolve-dispute-btn"  data-task_order_id="<?php echo esc_attr($order_id); ?>" data-employer-id="<?php echo esc_attr($employer_id); ?>" data-freelancer-id="<?php echo esc_attr($freelancer_id); ?>" data-dispute-id="<?php echo esc_attr($dispute_id); ?>" data-task-id="<?php echo esc_attr($task_id); ?>"><?php esc_html_e('Submit', 'workreap');?><span class="rippleholder wr-jsripple"><em class="ripplecircle"></em></span></a>
				...
				<?php if($dispute_resolve_status !== 'resolved'){?>
					<form class="wr-themeform wr-refundform_form" id="dispute-reply-form">
						...
						<div class="wr-disputebtn">
							<a href="javascript:void(0);" id="dispute-reply-btn" class="wr-btn"><?php esc_html_e('Submit', 'workreap'); ?><span class="rippleholder wr-jsripple"><em class="ripplecircle"></em></span></a>
