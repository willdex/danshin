<?php
/**
 * Dashboard Employer Orders Listing
 *
 * @package     Workreap
...
$page_title_key = !empty($_GET['order_type']) ? $_GET['order_type'] : esc_html__('All','workreap');
                    ...
                    <fieldset>
                        <div class="wr-themeform__wrap ">
                            <div class="form-group wo-inputicon">
                                ...
                                <input type="text" name="search_keyword" class="form-control" value="<?php echo esc_attr($search_keyword) ?>" placeholder="<?php esc_attr_e('Search orders here','workreap');?>">
                            </div>
                        </div>
                    </fieldset>
                </form>
            ...
            <?php if( $query->have_posts() ){ ?>
                <div class="wr-tasklist">
                    <?php while ($query->have_posts()) : $query->the_post();
                        ...
                        $order_price    = isset($order) && $order ? $order->get_total() : '';
                        ...
                        <div class="wr-tabfilteritem">
                            ...
                            <?php do_action( 'workreap_task_complete_html', $order_id );?>
                            <div class="wr-extras">
                                <?php do_action( 'workreap_task_author', $freelancer_id, 'freelancers' );?>
                                ...
                                <?php if( !empty($downloadable) && $downloadable == 'yes' ){
                                        do_action( 'workreap_task_download_file', $task_id,$order_id );
                                } ?>
                            </div>
                        </div>
                    <?php endwhile;?>
