...
if( !class_exists('Workreap_Search_Banner_V6') ){
	class Workreap_Search_Banner_V6 extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Search Banner V6', 'workreap' );
		}
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="wt-formoptions">
													...
													<button type="submit" class="wt-searchbtn"><i class="wr-icon-search"></i> <?php esc_html_e('Search', 'workreap'); ?></button>
												</div>
											</div>
										</fieldset>
									</form>
							...
							<div class="col-xl-4">
								<figure class="wt-homeseven-img">
									<?php if( !empty($image['url'])) { ?>
										<img src="<?php echo esc_url( $image['url']);?>" alt="<?php esc_attr_e('Banner','workreap');?>">
									<?php } ?>
								</figure>
							</div>
						<?php } ?>
	...
	Plugin::instance()->widgets_manager->register_widget_type( new Workreap_Search_Banner_V6 ); 
}