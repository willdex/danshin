...
if( !class_exists('Workreap_Join_Banner') ){
	class Workreap_Join_Banner extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Join Now Banner', 'workreap' );
		}
		...
		protected function register_controls() {
			...
			$this->add_control(
				...
				[
					...
					'description'   => esc_html__( 'Add left side image. Leave it empty to hide.', 'workreap' ),
				]
			);
			...
			$this->add_control(
				...
				[
					'type'      	=> Controls_Manager::MEDIA,
					'label'     	=> esc_html__( 'Upload Image', 'workreap' ),
					'description'   => esc_html__( 'Add right side image. Leave it empty to hide.', 'workreap' ),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'description'   => esc_html__( 'Add section sub/side title. Leave it empty to hide.', 'workreap' ),
				]
			);
			$this->add_control(
				'details',
			...
			$this->add_control(
				...
				[
					'type'      	=> Controls_Manager::TEXT,
					'label'     	=> esc_html__( 'Button First Text', 'workreap' ),
					'description'   => esc_html__( 'Add First Button text. Leave it empty to hide.', 'workreap' ),
				]
			);
			...
			$this->add_control(
				...
				[
					'type'      	=> Controls_Manager::TEXT,
					'label'     	=> esc_html__( 'Button First URL', 'workreap' ),
					'description'   => esc_html__( 'Add Button First URL. Leave it empty to hide.', 'workreap' ),
				]
			);
			...
			$this->add_control(
				...
				[
					'type'      	=> Controls_Manager::TEXT,
					'label'     	=> esc_html__( 'Button 2nd Text', 'workreap' ),
					'description'   => esc_html__( 'Add Button 2nd Text. Leave it empty to hide.', 'workreap' ),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'label' 		=> esc_html__('Term Text', 'workreap'),
        			'description' 	=> esc_html__('Add Term Text. Leave it empty to hide.', 'workreap'),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'label' 		=> esc_html__('Hide section after login', 'workreap'),
					'options' 		=> [
                ...
                <div class="wt-joinnow">
					...
					<?php if( !empty($left_image) ){?>
						<div class="wt-joinnow__imgleft">
							<figure>
								<img class="wt-joinnow__imgleft--img" src="<?php echo esc_url($left_image);?>" alt="<?php esc_attr_e('Joun now','workreap');?>">
							</figure>
						</div>
					<?php } ?>
					<?php if( !empty($right_image) ){?>
						<div class="wt-joinnow__imgright">
							<figure>
								<img class="wt-joinnow__imgright--img" src="<?php echo esc_url($right_image);?>" alt="<?php esc_attr_e('Joun now','workreap');?>">
							</figure>
						</div>
					<?php } ?>
                </div>
