...
if( !class_exists('Workreap_Partner') ){
	class Workreap_Partner extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Partner', 'workreap' );
		}
		...
		protected function register_controls() {
			...
			$this->add_control(
				'size',
				[
					'label' => esc_html__( 'Add title font size', 'workreap' ),
			...
			$this->add_control(
				'title_color',
				[
					'label' => esc_html__( 'Title Color', 'workreap' ),
			...
			$this->add_control(
				'slider',
				[
					'label'  => esc_html__( 'Add team Partner', 'workreap' ),
