...
if( !class_exists('Workreap_Project_Steps') ){
	class Workreap_Project_Steps extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Project Steps', 'workreap' );
		}
		...
		protected function register_controls() {
			...
			$this->add_control(
				'btn_url',
				[
					'label' 		=> esc_html__( 'Add Button URL', 'workreap' ),
					'type'  		=> Controls_Manager::TEXT
				]
			);
			...
			$this->add_control(
				'steps',
				[
					'label'  => esc_html__( 'Add Project Setp', 'workreap' ),
					...
					'fields' => [
						...
						[
							'name'  => 'bg_color',
							'label' => esc_html__( 'Add Box background color', 'workreap' ),
							'type' => Controls_Manager::COLOR
						],
						[
							'name'  => 'step_title',
							'label' => esc_html__( 'Add Setp Title', 'workreap' ),
							'type'  => Controls_Manager::TEXT,
						],
						[
							'name'  => 'step_color',
							'label' => esc_html__( 'Add Setp title background color', 'workreap' ),
							'type' => Controls_Manager::COLOR
						],
						[
							'name'  => 'title',
