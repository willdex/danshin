...
if( !class_exists('Workreap_Welcome') ){
	class Workreap_Welcome extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Welcome Note', 'workreap' );
		}
		...
		protected function register_controls() {
			...
			$this->add_control(
				...
				[
        			...
        			'description' 	=> esc_html__('Upload video thumbnail. leave it empty to hide.', 'workreap'),
				]
			);
			...
			$this->add_control(
				...
				[
        			...
        			'description' 	=> esc_html__('Upload video link. leave it empty to hide.', 'workreap'),
				]
			);
//			$this->add_control(
//				'counter_item',
...
//						[
//							'name'  => 'counter_symbol',
//							'label' => esc_html__( 'Symbol', 'workreap' ),
//							'type'  => Controls_Manager::TEXT,
//						],
//						[
...
//			]);
		...
		protected function render() {
			...
			$counters   = !empty($settings['counter_item']) ? $settings['counter_item'] : array();
