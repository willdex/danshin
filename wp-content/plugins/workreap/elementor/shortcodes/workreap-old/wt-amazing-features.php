...
if( !class_exists('Workreap_Amazing_Features') ){
	class Workreap_Amazing_Features extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Amazing Features', 'workreap' );
		}
		...
		protected function register_controls() {
			...
			$this->add_control(
				...
				[
					...
					'label'     	=> esc_html__( 'Upload Sidebar Image', 'workreap' ),
			...
			$this->add_control(
				...
				[
					'type'      	=> Controls_Manager::MEDIA,
					'label'     	=> esc_html__( 'Upload Main Image', 'workreap' ),
					'description'   => esc_html__( 'Upload image. leave it empty to hide.', 'workreap' ),
				]
			);
			$this->add_control(
				...
				[
					...
					'fields' => [
						[
							'name' 			=> 'icon',
							'type'      	=> Controls_Manager::TEXT,
							'label'     	=> esc_html__( 'Add icon code', 'workreap' ),
							'description'   => esc_html__( 'Add icon code like(fa fa-chart-bar,fa fa-eye-slash or fa fa-comment-o)', 'workreap' ),
						],
						[
							'name'  => 'bg_color',
							'label' => esc_html__( 'Add icon background color', 'workreap' ),
							'type' => Controls_Manager::COLOR
						],
						[
							'name'  => 'icon_color',
							'label' => esc_html__( 'Add icon color', 'workreap' ),
							'type' => Controls_Manager::COLOR
						],
						[
							'name'  => 'title',
						...
						[
							'name'  => 'url',
							'label' => esc_html__( 'Add URL', 'workreap' ),
							'type'  => Controls_Manager::TEXT,
						],
						[
							'name' 			=> 'details',
