	      ...
	      <div id="atomchat_auth" class="tab">
		       	<div class="atomchat_auth_content">
						...
						<p style="margin-top: 8px;">
							<input type="text" class="atomchat_auth_key" name="atomchat_auth_key" id="auth_key_token" value="<?php echo esc_attr(get_option('atomchat_auth_key'));?>" style="width: 100%;" placeholder="Enter Auth Key">
						</p>
						<p>
						...
						<p style="margin-top: 8px;">
							<input type="text" class="atomchat_api_key" name="atomchat_api_key" id="api_key" value="<?php echo esc_attr(get_option('atomchat_api_key'));?>" style="width: 100%;" placeholder="Enter API Key">
						</p>
						<p>
							<b>Note:</b> The keys are present in your AtomChat Admin Panel -> API Keys (top-right button)
						</p>
