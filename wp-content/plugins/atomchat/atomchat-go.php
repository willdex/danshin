 ...
 */
	...
	$atomchat_logo = esc_url($atomchatPluginPath.'images/atomchat_final_logo.svg');
	$atomchat_feedback_img = esc_url($atomchatPluginPath.'images/feedback_one.png');
	$atomchat_feedback_two_img = esc_url($atomchatPluginPath.'images/feedback_two.png');
	$atomchat_feedback_background = esc_url($atomchatPluginPath.'images/feedback_background.jpeg');
