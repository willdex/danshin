...
if (!class_exists('AndroidApp_Core')) {
    ...
    class AndroidApp_Core
    {
        ...
        private function load_dependencies()
        {
             ...
             */
            require_once plugin_dir_path(dirname(__FILE__)) . 'public/partials/functions.php';
            ...
            /**
             * The class responsible for defining all actions that occur in the  workreap api jwt auth
             * side of the site.
             */
            require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-workreap-jwt.php';
